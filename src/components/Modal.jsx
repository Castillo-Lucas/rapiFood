          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            ...
            <div className="flex items-center min-h-screen px-4 py-8">
              ...
              <div className="relative w-full max-w-lg p-4 mx-auto bg-zinc-900 rounded-md shadow-lg">
                <div className="mt-3 sm:grid sm:grid-cols-4">
                  <div className="col-span-1 flex items-center justify-center flex-none w-14 h-14 mx-auto my-auto bg-teal-500 rounded-full">
                    <svg
                  ...
                  <div className="col-span-3 mt-2 text-center sm:ml-4 sm:text-left">
                    ...
                    <div className="items-center gap-2 mt-3 sm:flex">
                      ...
                      <button
                        className="w-5/12 sm:w-full mt-2 p-2.5 flex-1 font-normal text-base text-neutral-100 text-center rounded-r-lg sm:rounded-lg border border-gray-400 hover:bg-teal-600 hover:font-medium  active:bg-teal-900 active:font-normal transition-colors"
                        onClick={() => setShowModal(false)}
                      >
                        Ok
                      </button>
