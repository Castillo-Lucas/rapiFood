...
export default function RedCards() {
  return (
    <>
      <Swiper
        slidesPerView={1}
      ...
      >
        <SwiperSlide>
          <div >
            <a href="#" className="block max-w-sm p-6 bg-red-500 border rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
